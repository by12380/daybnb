            ...
            <div>
              <div className="flex flex-wrap items-center gap-2">
                {room.is_guest_favorite && (
                  <span className="rounded-full bg-gradient-to-r from-amber-500 to-orange-500 px-3 py-1 text-xs font-bold text-white shadow">Guest favorite</span>
                )}
                {room.is_luxe && (
                  <span className="rounded-full bg-gradient-to-r from-purple-500 to-indigo-500 px-3 py-1 text-xs font-bold text-white shadow">Luxe</span>
                )}
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-base font-semibold text-ink dark:text-dark-ink">
                  Hosted by {room.owner_name || "Your Host"}
                </p>
              ...
              <div>
                ...
                {allFeatures.length > 8 && (
                  <button
                    ...
                    className="mt-4 rounded-xl border border-ink px-6 py-3 text-sm font-semibold text-ink transition hover:bg-surface dark:border-dark-ink dark:text-dark-ink dark:hover:bg-dark-surface"
                  >
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <Card className="space-y-5">
                ...
                {/* Book CTA */}
                <Button onClick={() => navigate(`/book/${room.id}`)} className="w-full py-3 text-base">
                  Book Now
                </Button>
