...
const ConfirmModal = React.memo(({ open, booking, action, onClose, onConfirm }) => {
  ...
  const handleConfirm = useCallback(async () => {
    ...
    setProcessing(true);
    try {
      const thunk = isCheckIn ? checkInOwnerBooking : checkOutOwnerBooking;
...
export default function OwnerCheckInOut() {
  const dispatch = useDispatch();
  const { todayBookings, todayLoading } = useSelector((state) => state.owner);
