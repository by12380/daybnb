...
import { fetchOwnerBookingHistory } from "../../redux/slices/ownerSlice.js";
...
export default function OwnerBookingHistory() {
  ...
  const { historyBookings, historyTotal, historyLoading } = useSelector((state) => state.owner);
  ...
  useEffect(() => {
    dispatch(fetchOwnerBookingHistory({ tab: activeTab, limit: 200 }));
  }, [dispatch, activeTab]);
