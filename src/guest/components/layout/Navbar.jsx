...
export default function GuestNavbar() {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-border bg-white/80 backdrop-blur transition-colors duration-300 dark:border-dark-border dark:bg-dark-panel/80">
          ...
          {loading ? (
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-border bg-white px-2 py-1.5 shadow-sm transition hover:border-brand-300 hover:shadow-md dark:border-dark-border dark:bg-dark-panel dark:hover:border-brand-500"
              >
              ...
              {dropdownOpen && (
                <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-2xl border border-border bg-white py-2 shadow-xl dark:border-dark-border dark:bg-dark-panel">
                  <div className="border-b border-border px-4 pb-3 pt-2 dark:border-dark-border">
                    <p className="truncate text-sm font-semibold text-ink dark:text-dark-ink">{userName}</p>
                  ...
                  <div className="py-1">
                    <Link
                      ...
                      className="flex items-center gap-3 px-4 py-2.5 text-sm text-ink transition hover:bg-slate-50 dark:text-dark-ink dark:hover:bg-dark-surface"
                    >
                      <svg className="h-5 w-5 text-muted dark:text-dark-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="border-t border-border pt-1 dark:border-dark-border">
                    <button
