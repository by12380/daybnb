...
export default function GuestNavbar() {
  ...
  const { unreadCount } = useNotifications({ mode: "user", userId: user?.id, limit: 50 });
                ...
                <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-2xl border border-border bg-white py-2 shadow-xl">
                  ...
                  <div className="py-1">
                    ...
                    <Link
                      to="/notifications"
                      onClick={() => setDropdownOpen(false)}
                      className="flex items-center justify-between gap-3 px-4 py-2.5 text-sm text-ink transition hover:bg-slate-50"
                    >
